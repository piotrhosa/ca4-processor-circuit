...
-- Format output
    output =
      [string "Control inputs\n        ",
       ...
       string "\n        ",
       string "     st_loadxi0 = ", bit (st_loadxi0 state),
       string "     st_loadxi1 = ", bit (st_loadxi1 state),
       string "     st_loadxi2 = ", bit (st_loadxi2 state),
       string "     st_loadxi3 = ", bit (st_loadxi3 state),
